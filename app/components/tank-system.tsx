                ...
                <g 
                  ...
                  onClick={() => {
                    if (onPumpReset) {
                      ...
                      // MQTT 메시지 발행
                      if (mqttClient) {
                        mqttClient.publish('extwork/inverter1/command', "reset");
                        // 알림 발행
                        const notification = {
                          type: 'pump-reset',
                          pumpId: 1,
                ...
                <g 
                  ...
                  onClick={() => {
                    if (onPumpReset) {
                      ...
                      // MQTT 메시지 발행
                      if (mqttClient) {
                        mqttClient.publish('extwork/inverter2/command', "reset");
                        // 알림 발행
                        const notification = {
                          type: 'pump-reset',
                          pumpId: 2,
